  ...
  return (
    <main className="flex flex-col grid grid-cols-12 items-center px-24 py-32 bg-stone-50 bg-gradient-radial">
      <div className="col-start-2	col-span-6	">
        <h1
          className={`${tangerine.className} text-left text-5xl text-slate-600 object-bottom	`}
        >
          {" "}
          <span className="relative">
            <span
              className={`${parissienne.className} text-left text-[36px] text-slate-600`}
            >
              E
            </span>
          </span>
        ...
        <div className="grid grid-cols-2 gap-x-2 min-w-min border border-slate-600 p-10">
          <h1 className="col-span-2 font-semibold	text-left text-8xl text-slate-600 mb-2 hover:text-yellow-300 transition duration-500">
            Vivien Tran
          </h1>
